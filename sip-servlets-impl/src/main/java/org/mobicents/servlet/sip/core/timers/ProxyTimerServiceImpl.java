 ...
 *
 */
public class ProxyTimerServiceImpl extends ScheduledThreadPoolExecutor implements ProxyTimerService {
    ...
    public ProxyTimerServiceImpl() {
        super(SCHEDULER_THREAD_POOL_DEFAULT_SIZE, new NamingThreadFactory("sip_proxy_timer_service"));
        schedulePurgeTaskIfNeeded();
    }

    public ProxyTimerServiceImpl(int corePoolSize) {
        super(corePoolSize);
        schedulePurgeTaskIfNeeded();
    }
