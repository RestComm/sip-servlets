   ...
   /**
	...
	public Session createSession() {
	   ...
	   public Session createSession(String sessionId)
	   {
	      ...
	      ClusteredSession session = createEmptyClusteredSession(sipManagerDelegate.getSipFactoryImpl().getSipNetworkInterfaceManager());
	      ...
	      ConvergedSessionReplicationContext.bindSession(session, snapshotManager_);
...
//	      add((ClusteredSession) session, true);
	   ...
	   public Session findSession(String id)
	   {
	      ...
	      // the session.
	      if (session == null 
	            && !ConvergedSessionReplicationContext.isSessionBoundAndExpired(realId, snapshotManager_))
	      {
	         if (trace)
	   ...
	   public void remove(Session session)
	   {
	      ...
	      synchronized (clusterSess)
	      {
	         ...
	         try {
	            ...
	            ConvergedSessionReplicationContext.sessionExpired(clusterSess, realId, snapshotManager_);
	   ...
	   protected ClusteredSession loadSession(String realId)
	   {
	      ...
	      if (session == null)
	      {
	         ...
	         mustAdd = true;
	         session = createEmptyClusteredSession(sipManagerDelegate.getSipFactoryImpl().getSipNetworkInterfaceManager());
	      }
