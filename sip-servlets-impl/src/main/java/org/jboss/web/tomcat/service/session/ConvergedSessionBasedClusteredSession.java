 ...
 * 
 * Based on SessionBasedClusteredSession JBOSS AS 4.2.2 Tag
 * 
 * @author <A HREF="mailto:jean.deruelle@gmail.com">Jean Deruelle</A> 
 *
 */
public class ConvergedSessionBasedClusteredSession extends
		SessionBasedClusteredSession implements ConvergedHttpSession {
	 ...
	 */
	public ConvergedSessionBasedClusteredSession(JBossCacheSipManager manager, SipNetworkInterfaceManager sipNetworkInterfaceManager) {
		super(manager);
