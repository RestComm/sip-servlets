 ...
 * 
 */
public class DefaultSipServletMessageFactory implements
	...
	public MobicentsSipServletRequest createSipServletRequest(Request request,
		...
		return new DefaultSipServletRequestImpl(request,
	...
	public MobicentsSipServletResponse createSipServletResponse(
		...
		return new DefaultSipServletResponseImpl(response,
