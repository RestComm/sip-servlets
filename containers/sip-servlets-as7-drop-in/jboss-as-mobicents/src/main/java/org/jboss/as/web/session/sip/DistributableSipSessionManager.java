 ...
 * 
 */
public class DistributableSipSessionManager<O extends OutgoingDistributableSessionData> extends DistributableSessionManager implements
ClusteredSipSessionManager<O>, LocalDistributableConvergedSessionManager, DistributableSipSessionManagerMBean {
   ...
   protected String getNextId()
   {
	...
	{
		// Passivation is not yet supported
