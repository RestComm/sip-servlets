 ...
 *
 */
public class SipAnnotationProcessorImpl extends DefaultAnnotationProcessor implements SipAnnotationProcessor {
	...
	public SipAnnotationProcessorImpl(Context context, SipContext sipContext) {
		super(context);
