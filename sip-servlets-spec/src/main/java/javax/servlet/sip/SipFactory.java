...
public interface SipFactory{
    ...
    /**
     * Returns a new SipApplicationSession belonging to a SIP application identified by a specific name. 
     * This method is useful for creating a SipApplicationSession belonging to 
     * the specified SIP application from a SipFactory injected in a JEE application.
     * @param sipAppName name of a SIP application
