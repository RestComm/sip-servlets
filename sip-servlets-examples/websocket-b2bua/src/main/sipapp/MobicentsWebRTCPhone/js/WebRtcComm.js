        ...
        if(typeof(configuration) == 'object')
        {
            if(this.openedFlag==false)
            {
                if(this.checkConfiguration(configuration)==true)
                {
                    ...
                    this.jainSipStack=this.jainSipFactory.createSipStack(this.configuration.sipOutboundProxy, this.configuration.sipUserAgent);                    
                    ...
                    this.jainSipMessageFactory=this.jainSipFactory.createMessageFactory(this.jainSipListeningPoint);
