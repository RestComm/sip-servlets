...
//		initTomcatOnStartup = false;
    ...
    protected void setUp() throws Exception {
        ...
        int sender1Chat1Port = NetworkPortAssigner.retrieveNextPort();
        sender1Chat1 = new TestSipListener(sender1Chat1Port, containerPort, sender1Chat1ProtocolObjects, false);
        ...
        int sender2Chat1Port = NetworkPortAssigner.retrieveNextPort();
        sender2Chat1 = new TestSipListener(sender2Chat1Port, containerPort, sender2Chat1ProtocolObjects, false);
        ...
        int sender3Chat1Port = NetworkPortAssigner.retrieveNextPort();
        sender3Chat1 = new TestSipListener(sender3Chat1Port, containerPort, sender3Chat1ProtocolObjects, false);
        ...
        int sender1Chat2Port = NetworkPortAssigner.retrieveNextPort();
        sender1Chat2 = new TestSipListener(sender1Chat2Port, containerPort, sender1Chat2ProtocolObjects, false);
    ...
    /**
     * This test check that this is not possible to modify the request in the
     * @SipApplicationKey annotated method
     *
     * @throws InterruptedException
     * @throws SipException
     * @throws ParseException
