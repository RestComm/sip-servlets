...
//	private static final int TIMEOUT = 100000000;
    ...
    protected void setUp() throws Exception {
        ...
        int referPort = NetworkPortAssigner.retrieveNextPort();
        referTo = new TestSipListener(referPort, containerPort, referToProtocolObjects, true);
        ...
        params.put("referPort", String.valueOf(referPort));
        deployApplication(params);          

    }

    /**
     * Call flow tested : See RFC 3515 Page 11-13 in this test, Sip Servlet is
     * receiving the REFERs (Acts as Agent B in the RFC)
     */
    ...
    /**
     * Call flow tested : See RFC 3515 Page 11-13 in this test, Sip Servlet is
     * sending the REFERs (Acts as Agent A in the RFC)
     */
    ...
    /**
     * Call flow tested : See RFC 3515 Page 13-15 in this test, Sip Servlet is
     * receiving the REFERs (Acts as Agent B in the RFC)
     */
