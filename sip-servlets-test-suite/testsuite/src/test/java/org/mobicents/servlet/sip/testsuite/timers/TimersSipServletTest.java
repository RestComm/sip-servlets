...
//	private static final int TIMEOUT = 100000000;
    ...
    public SipStandardContext deployApplication(Map<String, String> params) {
        SipStandardContext ctx = deployApplication(
                projectHome + "/sip-servlets-test-suite/applications/timers-sip-servlet/src/main/sipapp",
                "sip-test",
                params,
                null,
                Integer.valueOf(1),
                null);//setting the sip application timeout to 1 minutes instead of the regular 3 minutes
    ...
    protected void setUp() {
        try {
            ...
            context = deployApplication(params);
        } catch (Exception ex) {
