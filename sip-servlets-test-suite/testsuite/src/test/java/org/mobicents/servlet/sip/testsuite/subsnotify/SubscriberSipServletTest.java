...
//	private static final int TIMEOUT = 100000000;
     ...
     */
    public void testSipServletSendsSubscribe() throws Exception {
...
//		receiver.sendInvite();
    ...
    public void testSipServletsReceiveNotifyMultipart() throws Exception {
        ...
        params.put("servletContainerPort", String.valueOf(containerPort));
        params.put("testPort", String.valueOf(receiverPort));
        params.put("testMultipart", "testMultipart");
        deployApplication(params);        
    ...
    public void testSipServletsReceiveSendNotifyMultipart() throws Exception {
        ...
        params.put("servletContainerPort", String.valueOf(containerPort));
        params.put("testPort", String.valueOf(receiverPort));
        params.put("testSendMultipart", "testSendMultipart");
        deployApplication(params);
    ...
    public void testSipServletsReceiveNotifyMimeMultipartWhitespace() throws Exception {
        ...
        params.put("servletContainerPort", String.valueOf(containerPort));
        params.put("testPort", String.valueOf(receiverPort));
        params.put("testMimeMultipartWhitespaces", "testMimeMultipartWhitespaces");
        deployApplication(params);        
