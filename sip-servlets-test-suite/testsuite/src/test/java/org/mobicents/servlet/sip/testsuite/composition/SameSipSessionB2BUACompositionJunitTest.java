...
/**
 * Non regression test for Issue 790 : 1 SipSession should not be used in 2
 * different app session
 * (http://code.google.com/p/mobicents/issues/detail?id=790)
 *
...
//	private static final int TIMEOUT = 100000000;
    ...
    protected void setUp() throws Exception {
        ...
        autoDeployOnStartup = false;
        super.setUp();
        TO_DOMAIN = "" + System.getProperty("org.mobicents.testsuite.testhostaddr") + ":" + containerPort;
