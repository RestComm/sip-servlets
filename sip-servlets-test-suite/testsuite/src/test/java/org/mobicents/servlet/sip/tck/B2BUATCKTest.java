 ...
 * @author
 */
public class B2BUATCKTest extends SipServletTestCase {

    private static transient Logger logger = Logger.getLogger(B2BUATCKTest.class);

    public B2BUATCKTest(String name) {
        super(name);
    ...
    public void deployApplication() {
        assertTrue(tomcat.deployContext(
                projectHome + "/build/jsr289-tck/tck/dist/b2bua.sar",
                "sip-test-context-b2bua", "sip-test-b2bua"));
    }
    ...
    public void testB2BUATCKApp() throws Exception {
        assertTrue(true);
