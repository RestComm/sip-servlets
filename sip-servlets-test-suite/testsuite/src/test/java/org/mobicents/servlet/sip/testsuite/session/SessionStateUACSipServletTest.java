...
public class SessionStateUACSipServletTest extends SipServletTestCase {
    ...
    public void deployApplication(Map<String, String> params, ConcurrencyControlMode concurrencyControlMode) {
        SipStandardContext context = deployApplication(projectHome
                + "/sip-servlets-test-suite/applications/session-state-uac/src/main/sipapp",
    ...
    public void testSessionStateUAC_1xx_4xx() throws Exception {
        ...
        deployApplication(params, ConcurrencyControlMode.None);
    ...
    /**
     * http://code.google.com/p/mobicents/issues/detail?id=1438 Sip Session
     * become TERMINATED after receiving 487 response to subsequent request
     */
    ...
    public void testTransactionTimeoutResponse() throws Exception {
        ...
        params.put("testPort", String.valueOf(receiverPort));
        params.put("receiverPort", String.valueOf(receiverPort));
        params.put("testTimeout", "true");
        deployApplication(params, ConcurrencyControlMode.SipSession);        
