...
//	private static final int TIMEOUT = 100000000;
    ...
    private void startLoadBalancer(int receiverPort) {
        ipBalancerExternal = new UDPPacketForwarder(IPLB_ADDRESS_EXTERNAL, containerPort, "" + System.getProperty("org.mobicents.testsuite.testhostaddr") + "");
        ipBalancerExternal.start();
        ipBalancerInternal = new UDPPacketForwarder(IPLB_ADDRESS_INTERNAL, receiverPort, "" + System.getProperty("org.mobicents.testsuite.testhostaddr") + "");
    ...
    public void testSpeedDialLocationServiceCallerSendBye() throws Exception {
        ...
        sender = new TestSipListener(senderPort, IPLB_ADDRESS_EXTERNAL, senderProtocolObjects, true);
        sender.setRecordRoutingProxyTesting(true);
        SipProvider senderProvider = sender.createProvider();

        int receiverPort = NetworkPortAssigner.retrieveNextPort();
        receiver = new TestSipListener(receiverPort, IPLB_ADDRESS_EXTERNAL, receiverProtocolObjects, false);
        receiver.setRecordRoutingProxyTesting(true);
        SipProvider receiverProvider = receiver.createProvider();

        startLoadBalancer(receiverPort);
    ...
    public void testSpeedDialLocationServiceCalleeSendBye() throws Exception {
        int senderPort = NetworkPortAssigner.retrieveNextPort();
        sender = new TestSipListener(senderPort, IPLB_ADDRESS_EXTERNAL, senderProtocolObjects, false);
        sender.setRecordRoutingProxyTesting(true);
        SipProvider senderProvider = sender.createProvider();
