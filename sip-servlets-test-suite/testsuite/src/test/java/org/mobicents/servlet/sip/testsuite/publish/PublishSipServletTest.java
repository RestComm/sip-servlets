...
//	private static final int TIMEOUT = 100000000;
    ...
    protected void setUp() throws Exception {
        ...
        int watcherPort = NetworkPortAssigner.retrieveNextPort();
        watcher = new TestSipListener(watcherPort, containerPort, watcherProtocolObjects, true);
        ...
        int puaPort = NetworkPortAssigner.retrieveNextPort();
        pua = new TestSipListener(puaPort, containerPort, puaProtocolObjects, true);
        ...
        params.put("testPort", String.valueOf(watcherPort));
        deployApplication(params);        
    }

    /**
     * Call flow tested : See RFC 3903 Page 23 in this test, Sip Servlet is
     * acting as PA(ESC)
     */
