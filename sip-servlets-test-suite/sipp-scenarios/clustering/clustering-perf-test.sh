...
if [ $# -ne 0 ]; then
	case $1 in	
	    proxy)
	    		...
	    		./sipp $TEST_IP:5080 -sf proxy/location-service-receiver.xml -i $TEST_IP -p 5090 -bg
	    		./sipp $TEST_IP:5080 -s receiver-failover -sf proxy/location-service-sender.xml -trace_err -i $TEST_IP -p 5050 -r 5 -m 100000 -rsa $TEST_IP:5060 -nd
	            ;;
	    b2bua)
	    		rm ./b2bua/*.log
	            echo "Distributed example used is b2bua";
	            ./sipp $TEST_IP:5080 -sf b2bua/call-forwarding-receiver.xml -i $TEST_IP -p 5090 -bg 
	    		./sipp $TEST_IP:5080 -s receiver -sf b2bua/call-forwarding-sender.xml -trace_err -i $TEST_IP -p 5050 -r 5 -m 100000 -rsa $TEST_IP:5060 -nd
	            ;;
	    b2bua-remote-send-bye)
	    		...
	    		./sipp $TEST_IP:5080 -s receiver -sf b2bua/call-forwarding-sender-receives-bye.xml -trace_err -i $TEST_IP -p 5050 -r 1 -m 1 -rsa $TEST_IP:5060 -nd
	            ;;
		uac)
				rm ./uac/*.log
	            echo "Distributed example used is uac";
	            ./sipp $TEST_IP:5080 -sf uac/receiver.xml -i $TEST_IP -p 5090 -timeout 30
	            ;;	          
		c2c)
                ...
                killall sipp
	            ./sipp $TEST_IP:5080 -sf converged-click2call/receiver.xml -i $TEST_IP -p 5090 -timeout 100 -bg
                ./sipp $TEST_IP:5080 -sf converged-click2call/receiver-sendbye.xml -i $TEST_IP -p 5091 -timeout 100 -bg
                sleep 1
	    ...
	    uas-reinvite)
	    		...
	    		./sipp $TEST_IP:5080 -s isendbye -sf uas/clustering-reinvite-uac.xml -trace_err -i $TEST_IP -p 5050 -r 1 -m 1 -rsa $TEST_IP:5060 -nd
	    		;;	            	   
	    uas-timer)
	    		rm ./uas/*.log
	            echo "Distributed example used is uas";
	    		./sipp $TEST_IP:5080 -s yousendbye -sf uas/clustering-uac-timer.xml -trace_err -i $TEST_IP -p 5050 -r 1 -m 1 -rsa $TEST_IP:5060 -nd
	            ;;
	    *)
	    		rm ./uas/*.log
	            echo "Distributed example used is uas";
			...
			#./sipp $TEST_IP:5080 -s isendbye -sf uas/clustering-uac.xml -i $TEST_IP -p 5055 -r 5 -m 100000 -rsa $TEST_IP:5060 -nd
	            ;;
    esac
fi
