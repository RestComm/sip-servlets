...
run sh prepare-jboss-server-for-clustering-failover-network.sh from this directory on both machines
run sh start-lb-network.sh from this directory
run sh start-jboss-server-all.sh from this directory on both machines
run sh clustering-failover-test-network.sh from this directory 
