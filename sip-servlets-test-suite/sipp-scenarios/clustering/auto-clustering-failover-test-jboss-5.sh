...
export ports1="ports-default"
export ports2="ports-01"
...
./auto-start-jboss-server-jboss-5.sh $config2 $config2.pid $ports2 2 custom-b2bua
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 custom-b2bua
...
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 custom-b2bua-udp-tcp
...
#The test killed server 1, so we start it again
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 custom-b2bua-tcp-tcp
...
./auto-start-jboss-server-jboss-5.sh $config2 $config2.pid $ports2 2 b2bua
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 b2bua
...
#The test killed server 1, so we start it again
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 b2bua-remote-send-bye
...
#The test killed server 1, so we start it again
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 b2bua-remote-send-bye-no-ring
...
./auto-start-jboss-server-jboss-5.sh $config2 $config2.pid $ports2 2 proxy
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 proxy
...
#The test killed server 1, so we start it again
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 proxy-remote-send-bye
...
./auto-start-jboss-server-jboss-5.sh $config2 $config2.pid $ports2 2 uas
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 uas
...
#The test killed server 1, so we start it again
./auto-start-jboss-server-jboss-5.sh $config1 $config1.pid $ports1 1 uas-reinvite
