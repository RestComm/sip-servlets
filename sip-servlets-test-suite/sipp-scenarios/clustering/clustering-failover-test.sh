...
if [ $# -eq 4 ]; then
	case $1 in	
	    ...
	    custom-b2bua-udp-tcp)
	            ...
	            echo""| sipp $MSS_IP:5080 -sf b2bua/custom-call-forwarding-receiver.xml -trace_err -trace_msg -nd -i $SIPP_IP -p 5090 -t t1 >sipp-uas-log-$1.txt 2>&1 &
	    ...
	    custom-b2bua-tcp-tcp)
	            ...
	            echo""| sipp $MSS_IP:5080 -nd -sf b2bua/custom-call-forwarding-receiver.xml -trace_err -trace_msg -i $SIPP_IP -p 5090 -t t1 >sipp-uas-log-$1.txt 2>&1 &
	    ...
	    b2bua)
	            ...
	            echo""| sipp $MSS_IP:5080 -sf b2bua/call-forwarding-receiver.xml -trace_err -trace_msg -i $SIPP_IP -p 5090 -nd >sipp-uas-log-$1.txt 2>&1 &
	    ...
	    b2bua-info)
	            ...
	            echo""| sipp $MSS_IP:5080 -sf b2bua/call-forwarding-receiver-info.xml -trace_err -trace_msg -i $SIPP_IP -p 5090 -nd >sipp-uas-log-$1.txt 2>&1 &
	    ...
	    b2bua-remote-send-bye)
	            ...
	            echo""| sipp $MSS_IP:5080 -sf b2bua/call-forwarding-receiver-sends-bye.xml -trace_err -trace_msg -i $SIPP_IP -p 5090 -nd >sipp-uas-log-$1.txt 2>&1 &
	    ...
	    b2bua-remote-send-bye-no-ring)
	            ...
	            echo""| sipp $MSS_IP:5080 -sf b2bua/call-forwarding-receiver-sends-bye-no-ring.xml -trace_err -trace_msg -i $SIPP_IP -p 5090 -nd >sipp-uas-log-$1.txt 2>&1 &
	    		sipp $MSS_IP:5080 -s receiver -sf b2bua/call-forwarding-sender-receives-bye.xml -trace_err -i $SIPP_IP -p 5050 -r $RATE -m $CALLS -rsa $LB_IP:5060 -trace_msg -nd -timeout $ACTIVE_TIMEOUT -timeout_error
	            ;;
		uac)
				rm ./uac/*.log
