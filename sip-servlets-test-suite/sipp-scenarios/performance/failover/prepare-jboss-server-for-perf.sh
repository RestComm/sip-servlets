cp ../jboss-setup/failover-server-jboss.xml $JBOSS_HOME/server/default/deploy/jboss-web.deployer/server.xml
...
cp ../../../../sip-servlets-examples/simple-sip-servlet/target/simple-sip-servlet-1.0.war $JBOSS_HOME/server/default/deploy
