cp ../jboss-setup/server-jboss-b2bua.xml $JBOSS_HOME/server/default/deploy/jboss-web.deployer/server.xml
...
cp ../../../../sip-servlets-examples/call-forwarding/call-forwarding-b2bua-servlet-dar.properties $JBOSS_HOME/server/default/conf/dars/call-forwarding-b2bua-servlet-dar.properties
