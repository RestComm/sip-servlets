...
cp ../../../../sip-servlets-examples/call-forwarding/call-forwarding-b2bua-servlet-dar.properties $CATALINA_HOME/conf/dars/call-forwarding-b2bua-servlet-dar.properties
