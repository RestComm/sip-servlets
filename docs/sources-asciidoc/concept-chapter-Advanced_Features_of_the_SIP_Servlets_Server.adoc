...
The advanced features of SIP Servlets include Concurrency and  Congestion Control, load balancing with the Restcomm Load Balancer, and, exclusively for Restcomm for JBoss, clustering and failover support.
