 ...
 *
 */
public class DefaultSipServletResponseImpl extends SipServletResponseImpl
		implements MobicentsSipServletResponse {

	/**
	 * 
	 */
	public DefaultSipServletResponseImpl() {
	 ...
	 */
	public DefaultSipServletResponseImpl(Response response,
